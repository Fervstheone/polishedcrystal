...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move DOUBLE_SLAP,     EFFECT_MULTI_HIT,          15, NORMAL,     95, 10,   0, PHYSICAL
	...
	move FIRE_PUNCH,      EFFECT_BURN_HIT,           90, FIRE,      100, 15,  10, PHYSICAL
	move ICE_PUNCH,       EFFECT_FREEZE_HIT,         90, ICE,       100, 15,  10, PHYSICAL
	move THUNDERPUNCH,    EFFECT_PARALYZE_HIT,       90, ELECTRIC,  100, 15,  10, PHYSICAL
	move SCRATCH,         EFFECT_NORMAL_HIT,         40, NORMAL,    100, 35,   0, PHYSICAL
	move X_SCISSOR,       EFFECT_NORMAL_HIT,         90, BUG,       100, 15,   0, PHYSICAL
	move NIGHT_SLASH,     EFFECT_NORMAL_HIT,         80, DARK,      100, 15,   0, PHYSICAL
	move AIR_SLASH,       EFFECT_FLINCH_HIT,         80, FLYING,     95, 15,  30, SPECIAL
...
endc
	move GUST,            EFFECT_GUST,               50, FLYING,    100, 35,   0, SPECIAL
	move WING_ATTACK,     EFFECT_NORMAL_HIT,         70, FLYING,    100, 35,   0, PHYSICAL
...
endc
	move DAZZLINGLEAM,    EFFECT_NORMAL_HIT,         90, FAIRY,     100, 10,   0, SPECIAL
	...
	move DOUBLE_KICK,     EFFECT_DOUBLE_HIT,         40, FIGHTING,  100, 30,   0, PHYSICAL
	move FLARE_BLITZ,     EFFECT_FLARE_BLITZ,       120, FIRE,      100, 15,  10, PHYSICAL
	move STONE_EDGE,      EFFECT_NORMAL_HIT,        110, ROCK,       85,  5,   0, PHYSICAL
...
endc
	...
	move PSYBEAM,         EFFECT_CONFUSE_HIT,        70, PSYCHIC,   100, 20,  10, SPECIAL
	move BUBBLE_BEAM,     EFFECT_SPEED_DOWN_HIT,     70, WATER,     100, 20,  10, SPECIAL
	move AURORA_BEAM,     EFFECT_ATTACK_DOWN_HIT,    70, ICE,       100, 20,  10, SPECIAL
...
if DEF(FAITHFUL)
	...
	move FIRE_SPIN,       EFFECT_TRAP,               40, FIRE,       95, 15,   0, SPECIAL
endc
...
endc
	...
	move DRAGON_PULSE,    EFFECT_NORMAL_HIT,         95, DRAGON,    100, 10,   0, SPECIAL
...
endc
	...
	move VENOSHOCK,       EFFECT_CONDITIONAL_BOOST,  75, POISON,    100, 10,   0, SPECIAL
...
endc
	move BONEMERANG,      EFFECT_DOUBLE_HIT,         50, GROUND,     95, 10,   0, PHYSICAL
	...
	move AEROBLAST,       EFFECT_NORMAL_HIT,        120, FLYING,     95,  5,   0, SPECIAL
	...
	move FEINT_ATTACK,    EFFECT_ALWAYS_HIT,         70, DARK,       -1, 20,   0, PHYSICAL
...
endc
	...
	move GIGA_DRAIN,      EFFECT_LEECH_HIT,          85, GRASS,     100, 10,   0, SPECIAL
	...
	move FALSE_SWIPE,     EFFECT_FALSE_SWIPE,        60, STEEL,    100, 40,   0, PHYSICAL
...
endc
	...
	move IRON_TAIL,       EFFECT_DEFENSE_DOWN_HIT,   95, STEEL,     100, 15,  30, PHYSICAL
	move METAL_CLAW,      EFFECT_ATTACK_UP_HIT,      60, STEEL,     100, 35,  10, PHYSICAL
...
endc
	...
	move CRUNCH,          EFFECT_DEFENSE_DOWN_HIT,   90, DARK,      100, 15,  20, PHYSICAL
