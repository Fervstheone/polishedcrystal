...
endc
	...
	dbp 82, GENGAR, MALE
if DEF(FAITHFUL)
		db LEFTOVERS, ABIL_GENGAR_CURSED_BODY | NAT_SPE_UP_ATK_DOWN
		ev_spread 252 SAt, 252 Spe
else
		db LEFTOVERS, ABIL_GENGAR_LEVITATE | NAT_SPE_UP_ATK_DOWN
		ev_spread 252 SAt, 252 Spe
endc
		db WILL_O_WISP, SHADOW_BALL, FOCUS_BLAST, SUBSTITUTE
	dbp 80, NINETALES, MALE
		db CHARCOAL, HIDDEN_ABILITY | NAT_SPE_UP_ATK_DOWN
		ev_spread 252 SAt, 252 Spe
		db NASTY_PLOT, SHADOW_BALL, FLAMETHROWER, WILL_O_WISP
	dbp 81, MAROWAK, MALE | ALOLAN_FORM
		db THICK_CLUB, ABILITY_1 | NAT_ATK_UP_SATK_DOWN
		ev_spread 252 HP, 252 Atk
		db BONEMERANG, STONE_EDGE, ICE_PUNCH, SHADOW_CLAW
	dbp 83, MISMAGIUS, MALE
...
BrockGroup:
	...
	; party
	dbp 84, ONIX
		db SOFT_SAND, ABILITY_1 | NAT_ATK_UP_SATK_DOWN
		ev_spread 252 Atk, 252 HP
		db IRON_HEAD, ROCK_SLIDE, EARTHQUAKE, SANDSTORM
	dbp 83, RHYPERIOR
		db KINGS_ROCK, ABILITY_2 | NAT_ATK_UP_SATK_DOWN
		ev_spread 252 Atk, 252 HP
	...
	dbp 85, GOLEM
		db LEFTOVERS, ABILITY_1 | NAT_ATK_UP_ATK_DOWN
		ev_spread 252 Atk, 252 HP
